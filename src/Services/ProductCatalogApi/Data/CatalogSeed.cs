...
namespace ProductCatalogApi.Data
{
    public class CatalogSeed
    {
        public static async Task SeedAsync(CatalogContext context)
        {
            ...
            {
                context.CatalogBrands.AddRange(GetPreconfiguredBrands());
                await context.SaveChangesAsync();
            }

            if (!context.CatalogTypes.Any())
            {
                context.CatalogTypes.AddRange(GetPreconfiguredTypes());
                await context.SaveChangesAsync();
            }
        ...
        static IEnumerable<CatalogType> GetPreconfiguredTypes()
        {
            return new List<CatalogType>()
            {
                new CatalogType(){Type = "Running"},
                new CatalogType(){Type = "Walk"},
